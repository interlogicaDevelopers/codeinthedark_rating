export default (data) => {
    return `<a-entity component-padding="0.1"  position="0 3.5 -3" rotation="" panel-color="#212121" visible="" material="color: #0c0c0c; fog: false; transparent: true; opacity: 0.9" geometry="depth: 0.01; height: 8; width: 12" id="voteContainer">
